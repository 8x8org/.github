...
**Repository:** `8x8org/.github`  
**Primary lifecycle classification:** `AUTHORITATIVE`  
**Contract version:** `ONE_FABRIC_REPOSITORY_ROLE_V1`  
**Recorded:** `2026-09-11 UTC`

## Why this repository exists

Public organization governance and community-health surface: org profile, contribution rules, security contacts, public-current-state index, templates, and reusable workflows.
...
Organization-wide public participation and disclosure rules, subordinate to private constitutional authority and public protocol contracts.
...
Supports all 8x8org repositories and links users to current public product/protocol sources.
...
GitHub organization surface only.
...
Must not disclose private topology/secrets or present organization documentation as proof that a capability is deployed.
