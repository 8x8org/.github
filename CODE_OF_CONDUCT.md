...
8x8 OS community a harassment-free experience for everyone, regardless of age,
...
- Publishing another person's private data or private-system topology
...
reported to the community maintainers **privately** through GitHub's private
report/abuse routes on the relevant repository, or via the private contact
described in [`SUPPORT.md`](SUPPORT.md).

**Do not** include credential values, wallet material, private-system topology,
or another person's private data in an abuse report. Describe the behavior, the
public location where it occurred, and the impact. All complaints will be
...
1. **Correction** — private, written warning and clarity around the violation.
